...
// styled-components
import {
  BoxInfo, BoxShop, BoxInfoInnerBox, BoxInfoInnerBoxText, BoxInfoInnerLists,
    ...
    <>
      ...
      <BoxShop height="100%">
        ...
        <BoxInfo flexDirection={isMd === "md" ? "row" : "column"}>
          {/* 수정버튼 */}
          <button
            className={`small-btn __${isInfoUpadte ? "green" : "white"} __info`}
            onClick={(e) => {
              e.preventDefault();
              setIsInfoUpadte(!isInfoUpadte);
            }}
          >
            {isInfoUpadte ? "수정" : "수정 완료"}
          </button>
          {/* 매장 이름 */}
          ...
          <BoxInfoInnerLists paddingLeft={isMd === "md" ? "40px" : "0px"}>
            <div className="box-info-inner-list" style={{ height: "auto" }}>
            ...
            <div className="box-info-inner-list">
            ...
            <div className="box-info-inner-list">
              ...
              <input type="text" className="info-inner__input__text" style={{ border: !isInfoUpadte ? "1px solid #BABABA" : "1px solid white", borderRadius: "2px" }} defaultValue="D" disabled={isInfoUpadte} />
            </div>
            <div className="box-info-inner-list">
            ...
            <div className="box-info-inner-list">
              ...
              <textarea className="info-inner__input__textarea" style={{ border: !isInfoUpadte ? "1px solid #BABABA" : "1px solid white", borderRadius: "2px", padding: "2px" }} defaultValue="D" disabled={isInfoUpadte} />
            </div>
          </BoxInfoInnerLists>
        </BoxInfo>
      </BoxShop>
      ...
      <BoxShop>
        ...
        <button
          className={`small-btn __${isIntroduceUpdate ? "green" : "white"} __info`}
          onClick={(e) => {
            e.preventDefault();
      ...
      <BoxShop>
        <button
          className={`small-btn __${isCategoryUpdate ? "green" : "white"} __info`}
          onClick={(e) => {
            e.preventDefault();
            setIsCategoryUpdate(!isCategoryUpdate);
          }}
        >
          {isCategoryUpdate ? "수정" : "수정 완료"}
        </button>
        <Subtitle title="매장 카테고리 관리 (최대 4개)" />
        {isCategoryUpdate && <GreenCheckBoxs title={categories} checked />}
      ...
      <BoxShop>
        ...
        <div>
          ...
          <div style={{
            display: "flex", flexDirection: "column", width: "100%", height: "auto", borderBottom: "1px solid #dbdbdb",
          }}
          >
            <span style={{
              height: "", fontWeight: 700, color: "#338f6c", margin: isMd === "md" ? "20px 0px 15px 0px" : "10px 0px",
            }}
            >
              기타 사항
            </span>
            <textarea
              style={{
                width: "100%", height: "150px", resize: "none", fontFamily: "Noto Sans KR", boxSizing: "border-box", padding: "10px",
              }}
              defaultValue="이번주는 쉬어가겠습니다"
            />
          </div>
        </div>
      </BoxShop>
      ...
      <BoxShop>
        ...
        <div style={{
          display: "flex", flexWrap: "wrap", marginTop: "-20px", boxSizing: "border-box", padding: isMd === "md" ? "" : "0px 10px",
        }}
        >
          {/* 반복문 처리 */}
          <ThumbnailBox marginLeft="0" marginTop="0" marginBottom="0">
            <div style={{ position: "relative" }}>
              <Thumbnail backgroundUrl="https://via.placeholder.com/600/24f355" style={{ width: "90px", height: "90px" }} onClick={() => { window.open("https://via.placeholder.com/600/24f355"); }} />
      ...
      <BoxShop>
        ...
        >
          <ThumbnailBox marginLeft="0" marginTop="0" marginBottom="0">
            <div style={{ position: "relative" }}>
              <Thumbnail backgroundUrl="https://via.placeholder.com/600/24f355" style={{ width: "90px", height: "90px" }} onClick={(e) => { window.open("https://via.placeholder.com/600/24f355"); }} />
              <ThumbnailRemoveButton style={{ position: "absolute", top: "3px", right: "3px" }} />
            </div>
          </ThumbnailBox>
          <ThumbnailBox marginLeft="0" marginTop="0" marginBottom="0">
      ...
      <BoxShop>
        ...
        <div style={{
          display: "flex", flexDirection: "column", alignItems: "center", width: "auto", height: "200px", border: "1px solid #828282", borderRadius: "2px", boxSizing: "border-box", marginBottom: "130px",
        }}
        >
          {/* <span style={{ marginTop: "20px", fontSize: "22px", fontWeight: 700, letterSpacing: "-0.5px", color: "#3DA38D" }}>인증 완료</span> */}
          <span style={{
            marginTop: "20px", fontSize: "22px", fontWeight: 700, letterSpacing: "-0.5px", color: "#BB9068",
          }}
          >
            인증 반려
          </span>
