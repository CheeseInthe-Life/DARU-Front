      ...
      <div className="join-input-container">
        ...
        <div className="join-select-box __post">
          ...
          <input
            ...
            name=""
            id="post"
            className={`input-text-box __text __${isMd} __post`}
            maxLength="4"
            placeholder="우편번호"
            onChange={(e) => {
              e.preventDefault();
            ...
            disabled
            defaultValue={kakaoAddress.zonecode}
          />
          <KakaoPostButton size={isMd} value={getAddress} />
          <LongInput title="" size={isMd} placeholder="주소" readOnly={false} disabled defaultValue={kakaoAddress.address} />
        ...
        <div className={`filebox __${isMd}`} style={{ marginTop: "15px" }}>
          ...
          <label
            className={`filebox __label __label__${isMd}`}
            htmlFor="thumbNail"
          >
            파일찾기
          </label>
        ...
        {menuImagesSrc !== null && (
          <ThumbnailBox marginLeft={isMd === "md" ? "200px" : "0"} marginBottom={isMd === "md" ? "15px" : "0"} marginTop={isMd === "md" ? "0" : "15px"}>
